...
public class UserNode implements Comparable<User> {
	...
	/**
	 * Compares a specified user to this nodes user.
	 * Returns < 0 if the user is smaller than this nodes user.
	 * Returns > 0 if the user is larger than this nodes user.
	 * Returns = 0 if the user is equal to this nodes user.
