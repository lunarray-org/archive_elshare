...
public class ShareSettings {
    ...
    public void setSharePath(String sharename, String sharepath) {
        ...
        Controls.getLogger().finer(
                "Added share: \"" + sharename + "\" at " + sharepath);
    }
    ...
    public void setData(String loc, Hash h, Hash nh, long i) {
        rsettings
                .setString(Settings.DEFAULT_LOC + FILE_LOC, nh.toString(), loc);
        rsettings.setByteArray(Settings.DEFAULT_LOC + HASH_LOC, nh.toString(),
                h.getBytes());
        rsettings.setLong(Settings.DEFAULT_LOC + ACCESSDATE_LOC, nh.toString(),
                i);
