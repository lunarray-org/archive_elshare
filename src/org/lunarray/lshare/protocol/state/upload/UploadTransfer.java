...
public class UploadTransfer implements RunnableTask {
    ...
    /** A variable for checking wether a transfer is done.
     * Set to true if the transfer is done, false if not.
     */
     ...
     * @throws IOException If the file cannot be read or no socket can be
     * bound to.
     */
