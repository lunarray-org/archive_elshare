...
public final class PacketUtil {
    /**
     * Injects the byte array source of length length into the target byte array
     ...
     */
    public static void injectByteArrayIntoByteArray(byte[] source, int length,
    ...
    public static String decode(byte[] data) {
        ...
        try {
            ...
            Controls.getLogger().fine(
                    "Error encoding " + "string (" + cce.getMessage() + ")");
        }
        return cb.toString();
    }
    ...
    public static byte[] encode(String message) {
        ...
        try {
            ...
            Controls.getLogger().fine(
                    "Error decoding " + "string (" + cce.getMessage() + ")");
        }
        return bytes.array();
    }
     ...
     * @param offset The offset to put it at.
     */
    public static void shortUToByteArray(int value, byte[] array, int offset) {
        array[offset] = (byte) (value >>> 8);
        array[offset + 1] = (byte) value;
    }
     ...
     * @param offset The offset to put it at.
     */
    public static void longToByteArray(long value, byte[] array, int offset) {
    ...
    public static long byteArrayToLong(byte[] array, int offset) {
        return ((long) ((array[offset] & 0xFFL) << 56)
                ...
                + (long) ((array[offset + 6] & 0xFFL) << 8) + (long) (array[offset + 7] & 0xFFL));
    }
